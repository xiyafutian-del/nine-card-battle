...
export const INITIAL_CARDS = [
  // ── 無属性ユニット ──
  card(1,  "ソルジャー",        1, 3,  2, "1.1", "unit",     "none"),
  card(2,  "シールドガード",     1, 5,  1, "1.1", "unit",     "none"),
  card(3,  "アーチャー",         2, 2,  2, "1.2", "unit",     "none"),
  card(4,  "アサシン",           2, 2,  4, "1.1", "unit",     "none"),
  card(5,  "ランサー",           3, 4,  3, "1.2", "unit",     "none"),
  card(6,  "メイジ",             3, 2,  4, "3.2", "unit",     "none"),
  card(7,  "ファランクス",       4, 6,  2, "3.1", "unit",     "none"),
  card(8,  "ヘビーアーマー",     4, 8,  2, "1.1", "unit",     "none"),
  card(9,  "スナイパー",         4, 1,  5, "1.3", "unit",     "none"),
  card(10, "キャノン",           5, 4,  6, "1.2", "unit",     "none"),
  card(11, "バリスタ",           5, 3,  5, "3.3", "unit",     "none"),
  card(12, "ドラゴン",           7, 10, 7, "3.3", "unit",     "none"),

  // ── タンク ──
  card(13, "アイアンウォール",       3, 8,  1, "1.1", "tank", "none", { tags:["タンク"] }),
  card(14, "スチールバスティオン",   5, 12, 2, "1.1", "tank", "none", { tags:["タンク"] }),

  // ── 施設 ──
  card(15, "畑",     3, 3, 0, "1.1", "facility", "none",
    { effect:{ trigger:"turn_start", action:"gain_cost", amount:1 },
      desc:"ターン開始時コスト+1" }),
  card(16, "商店",   5, 6, 0, "1.1", "facility", "none",
    { effect:{ trigger:"turn_start", action:"gain_cost", amount:1 },
      desc:"ターン開始時コスト+1" }),
  card(17, "鍛冶場", 4, 4, 0, "1.1", "facility", "none",
    { effect:{ trigger:"passive", action:"forge_adj" },
      desc:"隣接するユニットのATK+1" }),
  card(18, "大砲",         5, 5, 6, "3.2", "facility", "none"),
  card(19, "物見やぐら",   3, 3, 3, "1.3", "facility", "none"),
  ...
  card(22, "増援",   3, 0, 0, "1.1", "spell", "none",
  ...
  card(26, "スナイプ", 2, 0, 0, "1.1", "spell", "none",
