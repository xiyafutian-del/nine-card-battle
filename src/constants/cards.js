...
export const INITIAL_CARDS = [
  ...
  // ── 施設 ──
  card(15, "畑",     2, 3, 0, "1.1", "facility", "none",
  ...
  card(17, "鍛冶場", 104, 4, 0, "1.1", "facility", "none",
    { effect:{ trigger:"passive", action:"forge_adj" },
      desc:"隣接するユニットのATK+1" }),
  card(18, "大砲",         105, 4, 2, "3.3", "facility", "none"),
...
card(1001,  "スペードのA",        101, 1,  1, "1.1", "unit",     "none"),
card(1002,  "スペードの2",        2, 2,  1, "3.1", "unit",     "none"),
card(1003,  "スペードの3",        3, 5,  2, "1.1", "unit",     "none"),
card(1004,  "スペードの4",        104, 2,  2, "1.4", "unit",     "none"),
card(1005,  "スペードの2",        101, 1,  2, "1.1", "unit",     "none"),
card(1006,  "スペードの3",        101, 1,  2, "1.1", "unit",     "none"),
card(1007,  "スペードの1",        101, 1,  2, "1.1", "unit",     "none"),
card(1008,  "スペードの8",        101, 1,  2, "1.1", "unit",     "none"),
card(1011,  "スペードのJ",        7, 1,  11, "1.1", "unit",     "none"),
