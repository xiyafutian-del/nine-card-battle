...
export const INITIAL_CARDS = [
  // ── 無属性ユニット ──
  card(001,  "ソルジャー",        1, 1,  2, "1.1", "unit",     "none"),
  card(002,  "シールドガード",     1, 3,  1, "1.1", "unit",     "none"),
  card(003,  "アーチャー",         1, 1,  1, "d2", "unit",     "none"),
  card(004,  "アサシン",           2, 1,  4, "1.1", "unit",     "none"),
  card(005,  "ランサー",           2, 3,  2, "1.2", "unit",     "none"),
  card(006,  "メイジ",             3, 2,  2, "3.2", "unit",     "none"),
  card(007,  "ファランクス",       4, 6,  3, "3.1", "unit",     "none"),
  card(008,  "ヘビーアーマー",     4, 8,  2, "1.1", "unit",     "none",{ tags:["タンク"] }),
  card(009,  "スナイパー",         4, 1,  4, "d3", "unit",     "none"),
  card(010, "茂み",           0, 1,  0, "1.1", "unit",     "none"),
  card(011, "バリスタ",           5, 5,  3, "3.2", "unit",     "none"),
  card(012, "ドラゴン",           7, 9, 6, "3.3", "unit",     "none"),
