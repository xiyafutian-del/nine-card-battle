...
export const INITIAL_CARDS = [
  ...
  card(5,  "ランサー",           2, 4,  2, "1.2", "unit",     "none"),
  card(6,  "メイジ",             2, 1,  2, "3.2", "unit",     "none"),
  card(7,  "ファランクス",       4, 6,  3, "3.1", "unit",     "none"),
  card(8,  "ヘビーアーマー",     4, 8,  2, "1.1", "unit",     "none",{ tags:["タンク"] }),
  card(9,  "スナイパー",         5, 1,  4, "d3", "unit",     "none"),
  card(10, "茂み",           0, 1,  0, "1.1", "unit",     "none"),
  card(11, "バリスタ",           5, 5,  3, "3.2", "unit",     "none"),
  card(12, "ドラゴン",           9, 9, 6, "3.3", "unit",     "none"),
  card(13, "カカシ",       1, 1,  0, "1.1", "tank", "none", { tags:["タンク"] }),
  card(14, "バスティオン",   7, 10, 4, "1.2", "tank", "none", { tags:["タンク"] }),
  // ── 施設 ──
  card(15, "畑",     92, 3, 0, "1.1", "facility", "none",
    { effect:{ trigger:"turn_start", action:"gain_cost", amount:1 },
      desc:"ターン開始時コスト+1" }),
  card(16, "小型発電機",   4, 8, 0, "1.1", "facility", "none",
    { effect:{ trigger:"turn_start", action:"gain_cost", amount:1 },
      desc:"ターン開始時コスト+1" }),
  card(17, "鍛冶場", 104, 4, 0, "1.1", "facility", "none",
    { effect:{ trigger:"passive", action:"forge_adj" },
      desc:"隣接するユニットのATK+1" }),
  card(18, "柵",         1, 3, 0, "1.1", "facility", "none"),
  ...
  card(22, "加速",   3, 0, 0, "1.1", "spell", "none",
    { effect:{ trigger:"activate", target:"self", action:"draw", amount:3 },
      desc:"3枚ドロー" }),
...
card(1007,  "スペードの7",        101, 1,  2, "1.1", "unit",     "none"),
card(1008,  "スペードの8",        8, 5,  4, "1.1", "unit",     "none",{ tags:["先制"] }),
card(1011,  "スペードのJ",        9, 1,  11, "1.1", "unit",     "trump"),
//日本
card(1101,  "侍",        2, 2,  2, "1.1", "unit",     "none",{ tags:["先制"] }),
card(1102,  "小次郎",        6, 5,  2, "3.1", "unit",     "none",{ tags:["2回行動"] }),
card(1103,  "忍者",        4, 2,  3, "3.1", "unit",     "none",{ tags:["先制","速攻"] }),
card(1104,  "火縄銃",        3, 3,  4, "1.3", "unit",     "none",{ tags:["速攻","反動"] }),
card(1109,  "狐",        9, 7,  2, "３.3", "unit",     "none",{ tags:["先制","2回行動"] }),
//ヨーロッパ
  // 同行にEU属性3体
card(1201, "盾兵", 2, 5, 1, "1.1", "unit", "eu", {
  ...
  // ── 草属性施設（成長チェーン） ──
  card(45, "地衣類", 0, 1, 0, "1.1", "facility", "grass",
  ...
  { effect:{ trigger:"activate", target:"all_enemy_front", action:"stun" },
   ...
   card(3201, "子どもマンボウ", 91, 1, 1,"1.1", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:2 },
      tags:["成長2(魚)","先制"], desc:"手札の魚属性コスト2以下を召喚" }),
  card(3202, "イワシ", 92, 2, 2,"1.1", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:3 },
      tags:["成長3(魚)","先制"], desc:"手札の魚属性コスト3以下を召喚" }),
  card(3203, "サバ", 93, 2, 3,"1.2", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:4 },
      tags:["成長4(魚)","先制"], desc:"手札の魚属性コスト4以下を召喚" }),
  card(3204, "タイ", 94, 6, 2,"1.1", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:5 },
      tags:["成長5(魚)","先制"], desc:"手札の魚属性コスト5以下を召喚" }),
  card(3205, "タコ", 95, 4, 3,"3.2", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:6 },
      tags:["成長6(魚)","先制"], desc:"手札の魚属性コスト6以下を召喚" }),
  card(3206, "イカ", 95, 5, 1,"3.3", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:6 },
      tags:["成長6(魚)","先制"], desc:"手札の魚属性コスト6以下を召喚" }),
  card(3207, "マグロ", 96, 7, 3,"1.3", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:7 },
      tags:["成長7(魚)","先制"], desc:"手札の魚属性コスト7以下を召喚" }),
  card(3208, "サメ", 97, 8, 4,"1.3", "unit", "fish",
    { effect:{ trigger:"activate", action:"growth", filter:{ attr:"fish" }, maxCost:8 },
      tags:["成長8(魚)","先制"], desc:"手札の魚属性コスト8以下を召喚" }),
  card(3209, "クジラ", 98, 9, 3,"3.2", "unit", "fish"),
];
